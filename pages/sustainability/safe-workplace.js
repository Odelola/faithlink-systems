                ...
                <div>
                    ...
                    <section className="pt-24 pb-0">
                        ...
                        <aside className="basis-1/2">
                            <h1 className="text-textGray text-[20px]">This is the Health, Safety, Environment, and Security Policy for FAITHLINK SYSTEM LIMITED. It sets out management’s commitment to ensuring the HSE and welfare of all interested parties (Clients, employees, contractors, customers, and the general public).</h1>
