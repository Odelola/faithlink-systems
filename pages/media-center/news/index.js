            ...
            return (
                <Link href={`${getRoute["news"]}/${slug}`} key={id} className="hover:scale-[1.02]">
                    <div className="flex flex-col gap-y-4 relative">
                        ...
                        {/* <Link href={"#0"} className="text-primary flex items-center gap-x-2 absolute left-0 bottom-0">
                            <span className="link-item__span">DETAIL</span>
                            <i className="link-item__icon">
