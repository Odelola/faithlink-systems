              ...
              <form action="#0" className='md:w-[calc(100%-300px)]'>
                ...
                <div className="form-item my-5">
                  ...
                  <div className='text-[12px]'>
                    ...
                    By clicking on Send, you confirm that you have read and accept the <Link href="/privacy-policy" className='text-[16px] font-semibold'>Privacy Notice</Link> and <Link href="/cookie-policy" className='text-[16px] font-semibold'>Cookie Policy</Link>
                  </div>
