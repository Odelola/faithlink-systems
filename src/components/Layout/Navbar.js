            ...
            <nav className="pt-4">
              ...
              <ul className={`mx-7 mt-16`}>
                <li className='border-b border-[rgba(225,225,225,.5)]'>
                  ...
                  {mobileToggleId == 0 && <MobileSubMenu subLinks={["about us", "chairman's message", "milestones"]} mobileToggle={mobileToggle} setToggle={setToggle} setMobileToggle={setMobileToggle} />}
                </li>
                <li className='border-b border-[rgba(225,225,225,.5)]'>
