              ...
              <ul className="flex items-center">
                <li className="relative">
                  ...
                  <ul className="absolute left-0 invisible opacity-0 transition-all">
                    <li className="invisible opacity-0">
                      <Link href="/en/corporate/about-us" className="flex item-center justify-between w-full py-4 px-5 bg-white">
                    ...
                    <li className="sub-nav__item">
                      <Link href="/en/corporate/message-from-the-chairman" className="menu-card">
                    ...
                    <li className="sub-nav__item">
                      <Link href="/en/corporate/milestones" className="menu-card">
                        <figure className="menu-card__figure">
                          <figcaption>
                            MILESTONES
                          </figcaption>
