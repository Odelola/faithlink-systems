...
function Navbar() {
  ...
  function SubMenu({ subLinks, className = "" }) {
    return (
      <ul className={"absolute left-0 z-50 visible opacity-100 transition-all group-hover:visible group-hover:opacity-100 max-md:hidden" + className}>
        {subLinks?.map((item, index) => (
          <li key={item} className={`opacity-100 visible group-hover:visible group-hover:opacity-100 group-hover:delay-${75 * index}`} style={{ transition: "all .3s ease-in-out" }}>
          ...
          <div className="flex items-center gap-x-4">
            ...
            <nav className="max-md:w-full max-md:h-screen max-md:fixed max-md:left-0 max-md:top-0 max-md:overflow-y-scroll max-md:hidden" aria-label="Main">
              <ul className="flex items-center max-md:flex-col max-md:w-full max-md:h-full max-md:py-[10%] max-md:justify-between max-md:items-start">
                <MenuLinks linkName="CORPORATE" subLinks={["about us", "our team", "chairman's message", "milestones", "our story", "our vision and values"]} />
                <MenuLinks linkName="ACTIVITY FIELDS" subLinks={["power sector", "engineering services", "paas / eaas", "fibre optics"]} />
            ...
            <nav className="pt-4">
              ...
              <ul className={`mx-7 mt-16`}>
                <li className='border-b border-[rgba(225,225,225,.5)]'>
                  ...
                  {mobileToggleId == 0 && <MobileSubMenu subLinks={["about us", "our team", "chairman's message", "milestones", "our story", "our vision and values"]} mobileToggle={mobileToggle} setToggle={setToggle} setMobileToggle={setMobileToggle} />}
                </li>
                <li className='border-b border-[rgba(225,225,225,.5)]'>
                  ...
                  {mobileToggleId == 1 && <MobileSubMenu subLinks={["power sector", "engineering services", "pass / eaas", "fibre optics"]} mobileToggle={mobileToggle} setToggle={setToggle} setMobileToggle={setMobileToggle} />}
                </li>
                <li className='border-b border-[rgba(225,225,225,.5)]'>
                  <Link href="/" onClick={() => {setMobileToggle(prev => !prev); setMobileToggleId(prev => prev = 1);}} className='flex justify-between items-center text-white py-5 text-[16px]'>
                    SUSTAINABILITY
                    <svg width="6" height="11" viewBox="0 0 6 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      {mobileToggleId == 2 && <MobileSubMenu subLinks={["hse policy"]} mobileToggle={mobileToggle} setToggle={setToggle} setMobileToggle={setMobileToggle} />}
                </li>
                <li className='border-b border-[rgba(225,225,225,.5)]'>
